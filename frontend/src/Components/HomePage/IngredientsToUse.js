...
import '../Css/HomePage/IngredientsToUse.css';
        ...
        <div className="contenedor-Left">
            <div className="contenedor-Food">
                ...
                <div className="contenedor-Submit">
                    <Link to={{pathname: "/Recipes", state: currentFoods}}><input type="submit" className='submit-button'  value="¡Vamos a cocinar!"/></Link>
                </div>
            </div>
        </div>
